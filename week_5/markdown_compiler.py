...
def compile_strikethrough(line):
    ...
    if start_index is not None and stop_index is not None:
        new_line = line[:start_index] + '<ins>' + line[start_index +
                                                       2:stop_index] + '</ins>' + line[stop_index+2:]
    else:
        new_line = line
...
def compile_bold_stars(line):
    ...
    if start_index is not None and stop_index is not None:
        new_line = line[:start_index] + '<b>' + line[start_index +
                                                     2:stop_index] + '</b>' + line[stop_index+2:]
    else:
        new_line = line
...
def compile_code_inline(line):
    ...
    if start_index is not None and end_index is not None:
        ...
        s2 = t1.split('<')
        t2 = '&lt;'.join(s2)
        line = line[:start_index] + '<code>' + \
            t2 + '</code>' + line[end_index+1:]
    return line
...
def compile_links(line):
    ...
    if start_index_bracket is not None and start_index_parentheses is not None and end_index_bracket is not None and end_index_parentheses is not None:
        line = line[:start_index_bracket] + '<a href="' + line[start_index_parentheses+1:end_index_parentheses] + \
            '">' + line[start_index_bracket+1:end_index_bracket] + \
            '</a>' + line[end_index_parentheses+1:]
    return line
...
def compile_images(line):
    ...
    if exclamation is None:
        return line
    if start_index_bracket is not None and start_index_parentheses is not None and end_index_bracket is not None and end_index_parentheses is not None:
        line = line[:exclamation] + '<img src="' + line[start_index_parentheses+1:end_index_parentheses] + \
            '" ' + 'alt="' + \
            line[start_index_bracket+1:end_index_bracket] + \
            '" />' + line[end_index_parentheses+1:]
    return line
