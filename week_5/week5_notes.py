...
vietnamese_NFKD = 'lập trình máy tính là tốt nhất !!!'
...
# code point of a char is the number ord gives you
...
# r is for raw r'byte' == 'byte'

# information is always stored as bytes on a harddrive/ internet connections etc.
